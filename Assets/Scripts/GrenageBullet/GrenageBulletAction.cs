...
public class GrenageBulletActionNew : MonoBehaviour, IBulletNew
{
    private GrenageBulletNew bullet;
    private float timeToDamage;

    private void Start()
    {
        bullet = gameObject.transform.GetChild(0).GetComponent<GrenageBulletNew>();
        if (bullet)
        {
